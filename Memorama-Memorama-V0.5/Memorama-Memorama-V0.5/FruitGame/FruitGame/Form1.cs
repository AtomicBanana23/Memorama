...
namespace FruitGame
{
    public partial class Form1 : Form
    {
        ...
        SoundPlayer flipCard;
        SoundPlayer getPoint;

        public Form1()
        {
            InitializeComponent();
            WMP.URL = @"Persona-5-OST-09-Beneath-the-Mask-instrumental-version-.wav";
      ...
      /*  private void startGameTimer()
        ...
        private void clickImage(object sender, EventArgs e)
        {
            ...
            flipCard = new SoundPlayer(@"DeepwokenTalentCardFlipSoundEffect.wav");
            flipCard.Play();
            ...
            if (pic.Image == firstGuess.Image && pic != firstGuess)
            {
                ...
                {
                    firstGuess = pic;
                    getPoint = new SoundPlayer(@"CheckpointSoundEffect.wav");
                    getPoint.Play();
                }
                jugadores[jugador] += 1;
            ...
            if (pictureBoxes.Any(p => p != null && p.Visible)) return;
            ResetImages();
